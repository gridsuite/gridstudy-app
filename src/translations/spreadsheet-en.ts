...
const spreadsheetEn = {
    ...
    'spreadsheet/custom_column/column_name': 'Edit a column',
    'spreadsheet/custom_column/column_content': 'Column content',
    'spreadsheet/custom_column/column_content_description': `Column content is described with variable names (in order to reference grid data) and operators provided by MathJS library (in order to transform grid data). Example: maxP - p in order to display active power reserve within the generator spreadsheet`,
    'spreadsheet/custom_column/error/not_unique': 'Column names must be unique',
    'spreadsheet/custom_column/save_columns': 'Save',
    ...
    'spreadsheet/custom_column/update_custom_column': 'Update custom column',
    'spreadsheet/custom_column/delete_custom_column': 'Delete custom column',
