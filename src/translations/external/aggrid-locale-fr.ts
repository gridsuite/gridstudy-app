...
const aggrid_locale_fr = {
    ...
    'grid.equals': 'Égal à',
    'grid.notEqual': "N'est pas égal à",
    'grid.startsWith': 'Commence par',
    'grid.endsWith': 'Finit par',
    'grid.blank': 'Vide',
    ...
    'grid.greaterThanOrEqual': 'Plus ou égal à',
    'grid.andCondition': 'ET',
    'grid.orCondition': 'OU',
    'grid.inRangeStart': 'Début',
    'grid.inRangeEnd': 'Fin',
    'grid.filterOoo': 'Filtrer...',
    ...
    'grid.to': 'à',
    'grid.of': 'de',
    'grid.firstPage': 'Première page',
    'grid.previousPage': 'Page précédente',
