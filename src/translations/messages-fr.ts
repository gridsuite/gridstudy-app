...
const messages_fr = {
    ...
    ActiveValidity: 'Validité active',
    ReactiveValidity: 'Validité réactive',
    MeasurementType: 'Type de mesure',
    StatusType: 'Type de statut',
    OriginMeasurement: 'Mesure origine',
    ExtremityMeasurement: 'Mesure extrémité',
    Deviation: 'Ecart',
    MinBusbarSection: 'Jeu de barres min',
    MinBusbarSectionValue: 'Valeur jeu de barres min',
    MaxBusbarSection: 'Jeu de barres max',
    MaxBusbarSectionValue: 'Valeur jeu de barres max',
