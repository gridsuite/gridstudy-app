...
const messages_fr = {
    ...
    CsvNameBalances: 'BilansDeBoucherot',
    CsvNameNonZeroMeasurementsOnDisconnected: 'PuissanceNonNulleOuvrageHS',
    CsvNameZeroMeasurementsOnConnected: 'PuissanceNulleDépartFermé',
    CsvNameOriginExtremityDeviations: 'EcartsTransitsOrigineExtrémité',
    CsvNameOutOfBoundsMeasurements: 'InjectionsHorsLimites',
    CsvNameVoltageDeviations: 'EcartsTmTension',
