...
const messages_en = {
    'debug.message.downloadFile': 'Computation data will be downloaded upon its completion.',
    'debug.header.fileNotFound': 'Computation data not found',
    'debug.header.fileError': 'Computation data download failed',
    'export.message.started': 'Export of case {fileName} started',
    'export.message.succeeded': 'Export of case {fileName} succeeded',
    'export.message.failed': 'Node export failed',
    ...
    deleteStudyError: 'Cannot remove the study if you are not the owner',
    equipmentsSearchingError: 'An error occurred while searching the equipments',
    equipmentsLoadingError: 'An error occurred while loading the available equipments',
    equipmentsLoading: 'Loading...',

    renameStudyMsg: 'New study name:',
    renameStudy: 'Rename study',
    renameStudyError: 'Cannot rename the study if you are not the owner',
    renameStudyNotification: 'The study has been renamed from {oldStudyName} to {studyName}',
    ...
    copiedNodeInvalidationMsgFromOtherStudy: 'Clipboard content cleared due to changes in nodes in another tab',
    copiedNodeInvalidationMsgFromStudyClosure: 'Clipboard content cleared due to a study being closed',
    copiedNodeUpdateMsg: 'Clipboard content updated after copying a node in another tab',
    ...
    copiedModificationsInvalidationMsgFromOtherStudy:
        'Clipboard content cleared due to changes in modifications in another tab',
    copiedModificationsInvalidationMsgFromStudyClosure: 'Clipboard content cleared due to a study being closed',
    copiedModificationsUpdateMsg: 'Clipboard content updated after copying modifications in another tab',

    exportNetwork: 'Export the network',
    export: 'Export',
    'download.fileName': 'File name',
    exportFormat: 'Format of the export',
    exportStudyErrorMsg: 'No export format specified',
    exportCompression: 'Compression',
    exportCompressionErrorMsg: 'No export compression specified',

    modifyAccessRights: 'Modify the access rights',
    modifyAccessRightsError: "You cannot modify the access rights of a study you don't own",
    edit: 'Edit',
    openSubstationDiagram: 'Open substation diagram',
    openVoltageLevelDiagram: 'Open voltage level diagram',
    editSiteProperties: 'Edit site properties',

    studyNameErrorMsg: 'Study name should not be empty',
    caseNameErrorMsg: 'Please select the case name',
    caseDataErrorMsg: 'An error occurred when importing the case',
    ...
    studyNameAlreadyUsed: 'This study name is already used',
    ...
    createDiagramConfigLabel: 'Create a new network area diagram',
    updateDiagramConfigLabel: 'Replace an existing network area diagram',
    ...
    loadingGeoData: 'Loading geographic data in progress...',
    LoadingRemoteData: 'Loading...',
    loadingCreationStudy: 'Creation in progress...',

    computationInProgress: 'Computation in progress ...',
    ...
    modificationsForbiddenOnRootNode: 'Modifications forbidden on root node',
    images: 'Images',
    ...
    'I_(A)': 'I (A)',
    limit: 'limit',
    LimitLabelAOrKv: 'Limit (A or kV)',
    LimitLabel: 'Limit (A)',
    upComingOverloadDuration: 'Upcoming overload',
    actualOverloadDuration: 'Actual overload',
    CurrentViolationValue: 'Calculated current (A)',
    PatlLimitValue: 'PATL (A)',
    CurrentViolationLimit: 'Limit value (A)',
    VoltageViolationLimit: 'Voltage limit (kV)',
    VoltageViolationValue: 'Calculated voltage (kV)',
    load: 'load',
    Load: 'Load',
    ManuallyRefreshGeoData: 'Update map',
    ...
    VoltageLevelIdSide1: 'Voltage level ID 1',
    VoltageLevelIdSide2: 'Voltage level ID 2',
    VoltageLevelIdT3WSide1: 'Voltage level ID 1',
    VoltageLevelIdT3WSide2: 'Voltage level ID 2',
    VoltageLevelIdT3WSide3: 'Voltage level ID 3',
    ...
    NominalVT3WSide1: 'Nominal voltage 1 (kV)',
    NominalVT3WSide2: 'Nominal voltage 2 (kV)',
    NominalVT3WSide3: 'Nominal voltage 3 (kV)',
    ...
    'withoutunit.r': 'Series resistance',
    'withoutunit.x': 'Series reactance',
    ...
    DroopColumnName: 'Droop (%)',
    reactivePowerSetpoint: 'target Q (Mvar)',
    targetQ: 'target Q (Mvar)',
    RatioTap: 'Ratio tap',
    PhaseTap: 'Phase tap',
    RatioTap1: 'Ratio tap 1',
    PhaseTap1: 'Phase tap 1',
    RatioTap2: 'Ratio tap 2',
    PhaseTap2: 'Phase tap 2',
    RatioTap3: 'Ratio tap 3',
    PhaseTap3: 'Phase tap 3',
    RegulatingTerminal: 'Regulated node',

    LoadFlow: 'Loadflow',
    LoadFlowWithRatioTapChangers: 'Loadflow with ratio tap changers',
    Network: 'Network',
    SecurityAnalysis: 'Security analysis',
    VoltageInit: 'Voltage profile initialization',
    Indicators: 'Indicators',
    ReactiveSlacks: 'Reactive slacks',
    TotalInjection: 'Total injection',
    TotalConsumption: 'Total consumption',
    Slack: 'Slack (Mvar)',
    BusId: 'Bus ID',
    BusVoltages: 'Calculated voltage profile',
    BusVoltage: 'Voltage (kV)',
    BusAngle: 'Angle (°)',
    VoltageInitStatus: 'STATUS',
    startVoltageInitError: 'An error occurred while starting the voltage profile initialization',
    FilterEvaluationError: 'An error occurred while evaluating the filter',
    voltageInitError: 'An error occurred while executing the voltage profile initialization',
    voltageInitCancelError: 'The voltage profile initialization could not be cancelled',
    VoltageinitRootNetworkName: 'Root network : {rootNetworkName}',
    VoltageinitNodeName: 'Node : {nodeName}',
    VoltageinitDate: 'Computation date : {computationDate}',
    ...
    noOption: 'No options',
    maxSelection: 'selections maximum',
    options: 'options',

    DynamicSimulation: 'Dynamic simulation',
    DynamicSimulationRunError: 'An error occurred while executing the dynamic simulation',
    DynamicSimulationResults: 'Dynamic simulation results',

    DynamicSimulationGetMappingError: 'Get dynamic mappings',
    DynamicSimulationParametersChangeError: 'Dynamic simulation parameters change error',
    DynamicSimulationParametersSelection: 'Dynamic simulation parameters selection',

    DynamicSimulationMappingSelection: 'Select a mapping',
    DynamicSimulationResultTab: 'Page',
    DynamicSimulationResultChart: 'Graph',
    DynamicSimulationSyncPlotEnable: 'Click to disable action synchronization',
    DynamicSimulationSyncPlotDisable: 'Click to enable action synchronization',
    DynamicSimulationCloseTab: 'Close tab',
    DynamicSimulationAddTab: 'Add a tab',
    DynamicSimulationAddGraph: 'Add a graph',
    DynamicSimulationCloseGraph: 'Close graph',
    DynamicSimulationPlotScaleEnable: 'Enlarge graph',
    DynamicSimulationPlotScaleDisable: 'Restore graph',
    DynamicSimulationFullViewEnable: 'Enlarge result view',
    DynamicSimulationFullViewDisable: 'Restore result view',
    DynamicSimulationShowSeriesListDisable: 'Hide curve list',
    DynamicSimulationShowSeriesListEnable: 'Show curve list',
    DynamicSimulationSeriesListLeftAxis: 'Left axis',
    DynamicSimulationSeriesListAvailableCurves: 'Available curves',
    DynamicSimulationSeriesListRightAxis: 'Right axis',
    DynamicSimulationResultLayoutCols: 'Columns',

    FetchCountryError: 'An error occurred while fetching countries',
    FetchNominalVoltagesError: 'An error occurred while fetching nominal voltages',
    ...
    DynamicSimulationEventPropertyNodeFaultDuration: 'Node Fault Duration',
    DynamicSimulationEventPropertyRPu: 'Fault resistance R',
    DynamicSimulationEventPropertyXPu: 'Fault reactance X',
    DynamicSimulationEventSaveError: 'An error occurred while saving an event',
    DynamicSimulationEventScenario: 'Dynamic simulation events',
    DynamicSimulationEventDeleteError: 'Event deletion error',
    ...
    DynamicSimulationTabStatus: 'Status',
    ...
    SensibilityAnalysisParameters: 'Sensitivity analysis parameters',
    VariablesToSimulate: 'Variables to simulate',
    SimulatedContingencies: 'Simulated contingencies',
    getVariablesFiltersListError: "Can't fetch simulated variables lists",
    getBranchFiltersListError: "Can't fetch supervised branches filters lists",
    sensitivityAnalysisError: 'An error occurred when executing sensitivity analysis',
    SensitivityInDeltaMW: 'Sensitivity on branches in ΔMW',
    ...
    ForbiddenProviderError: 'You must run {provider} from a security type node',
    ...
    updateSwitchStateError: 'An error occurred while updating the switch state in diagram "{diagramTitle}"',
    ShortCircuitAnalysisError: 'An error occurred while executing the short circuit analysis',
    ShortCircuitAnalysisResultsError: 'An error occurred while retrieving short circuit analysis result',
    ShortCircuitAnalysisTabOneBus: 'One bus',
    ShortCircuitAnalysisTabAllBuses: 'All buses',
    OneBusShortCircuitAnalysis: 'One bus short circuit analysis',
    startSensitivityAnalysisError: 'An error occurred while executing the sensitivity analysis',
    IDNode: 'Bus',
    busVoltageLevel: 'Voltage level',
    IscKA: 'Isc (kA)',
    IscMinKA: 'Isc min (kA)',
    IscMaxKA: 'Isc max (kA)',
    PscMVA: 'Psc (MVA)',
    deltaCurrentIpMax: 'Isc - Isc max (kA)',
    deltaCurrentIpMin: 'Isc - Isc min (kA)',
    ...
    NextLimitNameCurrentViolation: 'Next limit name',
    Limit_name: 'Limit name',
    CalculatedValue: 'Calculated value (A or kV)',
    ...
    no: 'No',
    Loading: 'Load (%)',
    LimitLoading: 'Load (% limit)',
    PatlLoading: 'Load (% PATL)',
    undefinedValue: 'undefined',

    HighVoltageLimit: 'High voltage limit',
    HighVoltageLimitkV: 'High voltage limit (kV)',
    LowVoltageLimit: 'Low voltage limit',
    LowVoltageLimitkV: 'Low voltage limit (kV)',

    descStudyType: 'Study type',
    descTransient: 'Transient',
    securityAnalysisError: 'An error occurred while executing the security analysis',
    securityAnalysisCsvResultsError: 'An error occurred while exporting the security analysis results',
    securityAnalysisCopyResultsError: 'An error occurred while copying the security analysis results',
    shortCircuitAnalysisCsvResultsError: 'An error occurred while exporting the short circuit analysis results',
    startLoadFlowError: 'An error occurred while starting the load flow',
    LoadFlowResultsCurrentViolations: 'Current violations',
    LoadFlowResultsVoltageViolations: 'Voltage violations',
    LoadFlowResultsSummary: 'Summary',
    LoadFlowResultsConnectedComponents: 'Connected components',
    LoadFlowResultsCountryAdequacies: 'Country adequacies',
    LoadFlowResultsExchanges: 'Exchanges',
    LoadFlowResultsMainComponentToolTip: 'Main connected component only (0)',
    ComputationResultsLogs: 'Logs',

    'results.globalFilter.categories': 'Categories',
    'results.globalFilter.categoriesHelp':
        'Filtering is performed using a logical AND across categories, then a logical OR among filters belonging to the same category.',
    'results.globalFilter.clearAll': 'Clear all',
    'results.globalFilter.loadFilter': 'Load filter',
    'results.globalFilter.activeFilters': '{filtersCount} active filters',
    'results.globalFilter.activeFilter': '{filtersCount} active filter',
    'results.globalFilter.fillerText': 'Filtering',
    'results.globalFilter.recent': 'Recent',
    'results.globalFilter.substationProperty': 'Regions',
    'results.globalFilter.genericFilter': 'Elements',
    'results.globalFilter.substationFilter': 'Substations',
    'results.globalFilter.substationOrVoltageLevelFilter': 'Substations and voltage levels',
    'results.globalFilter.elementsHelp': 'Those filters exclude other elements type',
    'results.globalFilter.country': 'Countries',
    'results.globalFilter.voltageLevel': 'Voltage levels',
    'results.globalFilter.nonApplicable':
        'Filtering {filterName} is not applicable for the current results table and is inactive',
    'results.globalFilter.nonApplicableExtra':
        'Filtering {filterName} and {extraFiltersNum} others are not applicable for the current results table and are inactive',

    connectedComponentNum: 'Connected component number',
    synchronousComponentNum: 'Synchronous component number',
    status: 'Status',
    iterationCount: 'Iteration count',
    slackBusId: 'Slack bus ids',
    slackBusActivePowerMismatch: 'Slack bus active power mismatch (MW)',
    consumptions: 'Load (MW)',
    generations: 'Generation (MW)',
    countryAdequacyGeneration: 'Generation (MW)',
    countryAdequacyLoad: 'Load (MW)',
    exchanges: 'Exchanges (MW)',
    losses: 'Losses (MW)',
    netPosition: 'Net position (MW)',
    exchange: 'Net position - Exchanges (MW)',
    borders: 'Borders',
    distributedActivePower: 'Active power regulation (MW)',

    isOk: 'Ok',
    metrics: 'Metrics',

    SmartSubstationLayout: 'Smart',
    SmartWithHorizontalCompactionSubstationLayout: 'Smart with horizontal compaction',
    SmartWithVerticalCompactionSubstationLayout: 'Smart with vertical compaction',
    openSubstation: 'Open the substation',

    ConstraintsFromContingencies: 'Contingencies -> violations',
    ContingenciesFromConstraints: 'Violations -> contingencies',
    CutOffPowerFromConstraints: 'Cut-off power',

    selectionType: 'Selection type',

    loadType: 'Type',
    ConstantP: 'Constant p (MW)',
    ConstantQ: 'Constant q (Mvar)',
    BoundaryLines: 'Boundary Lines',
    PairingKey: 'UCTE Xnode',
    ...
    ConverterStationId1: 'Converter Station Id 1',
    ConverterStationId2: 'Converter Station Id 2',
    NominalV: 'Nominal V',
    HvdcLineId: 'HVDC Line Id',
    OprFromCS1toCS2: 'Operational limit (side_1 to side_2) (MW)',
    OprFromCS2toCS1: 'Operational limit (side_2 to side_1) (MW)',
    AcEmulation: 'AC emulation',
    K: 'K (MW/deg)',
    P0: 'P0 (side_1 to side_2) (MW)',
    PowerFactor: 'Power Factor',
    LossFactor: 'Loss Factor',
    StopComputation: 'Stop computation',
    genericConfirmQuestion: 'You are about to leave without saving your current modifications.',
    launchComputationConfirmQuestion:
        'You are about to start a computation although a change to the computation parameters is in progress.',

    ViewOnSpreadsheet: 'View in spreadsheet',
    ModifyFromMenu: 'Modify',
    ModifyCharacteristics: 'Modify characteristics',
    Rename: 'Rename',
    ...
    'importComposites.select': 'Select composite modifications',
    'importComposites.selected': 'Selected composite modifications: ',
    'importComposites.error': 'Error during the composite modification import.',
    'importComposites.step.selection': 'Selection',
    'importComposites.step.organization': 'Organization & sharing',
    'importComposites.shared': 'Shared',
    descriptionProperty: 'Description',
    DeleteModificationText:
        '{numberToDelete, plural, =0 {No modification to delete.} =1 {One modification will be permanently deleted.} other {# modifications will be permanently deleted.}}',
    ...
    buildNode: 'Build',
    insertNodeInNewBranch: 'New branch',
    SecuritySequence: 'Security sequence',
    removeNode: 'Remove',
    unbuildNode: 'Unbuild',
    ...
    NodeDeleteError: 'An error occurred while deleting node',
    NodeUpdateError: 'An error occurred while updating node',
    NodeDataFetchingError: 'An error occurred while fetching node data',
    SequenceCreateError: 'An error occurred while creating sequence',
    NodeUpdateColumnPositions: "An error occured while updating the nodes' positions in the tree",
    ...
    UndefinedDefaultValue: 'Undefined (default value)',
    Undefined: 'Undefined',
    Auxiliary: 'Auxiliary',
    ...
    errCutModificationMsg: 'Network modifications cut error',
    warnDuplicateModificationMsg: 'Number of modifications not copied :',
    errDeleteModificationMsg: 'Network modifications deletion error',
    errRestoreModificationMsg: 'Network modifications restore error',
    Type: 'Type',
    BRANCH: 'Branch',
    Hvdc: 'HVDC',
    VSC: 'HVDC (VSC)',
    LCC: 'HVDC (LCC)',
    BY_FORMULA: 'Modify by formula',
    BY_FILTER: 'Modify by filter',
    BY_TABLE: 'Modify by table',
    substationName: 'Substation name',
    activePower: 'p (MW)',
    maxActivePower: 'Max P (MW)',
    maxP: 'Max P (MW)',
    activePowerSetpoint: 'target P (MW)',
    targetP: 'target P (MW)',
    minActivePower: 'Min P (MW)',
    minP: 'Min P (MW)',
    ...
    NbModificationToPaste: 'Paste {nb} modification{several}',
    NbModificationToRestore: 'Restore {nb} modification{several}',
    energySource: 'Energy source',
    ReactivePowerRegulationText: 'Reactive regulation',
    ResetRegulationRule: 'Reset regulation rules',
    RatioRegulationTypeText: 'Ratio regulation',
    PhaseRegulationTypeText: 'Phase regulation',
    RatioRegulatingTerminal: 'Ratio regulated terminal',
    PhaseRegulatingTerminal: 'Phase regulated terminal',
    EditVoltageRegulation: 'Edit Regulating terminal',
    ...
    ShuntCurrentNumberOfSections: 'Current number of sections',
    ...
    BusBarHorizPos: 'Horizontal position',
    BusBarVertPos: 'Vertical position',
    CreateBusBarSection: 'Add bus bar section',
    CreateLink: 'Add link',
    BusBarSection: 'Bus bar section',
    VoltageLevelCreationError: 'Voltage level creation error',
    Breaker: 'Breaker',
    ...
    BusBarSectionsCopyingNotSupported:
        'Copying bus bar sections is not supported for this voltage level : values were set to their default',
    ...
    IncoherentRatioTapPositionError: 'The Tap position value is not consistent with the ratio tap changer steps data',
    IncoherentPhaseTapPositionError: 'The Tap position value is not consistent with the phase tap changer steps data',
    IncoherentRatioRegulatingTerminalError: 'The ratio tap Regulating terminal value must be filled',
    ...
    FilterCreationSuccess: 'Filter successfully created',
    ContingencyListCreationSuccess: 'Contingency list successfully created',
    FilterCreationIgnored: "The creation of the filter didn't complete",
    ContingencyListCreationIgnored: "The creation of the contingency list didn't complete",
    FilterUpdateSuccess: 'Filter successfully updated',
    FilterUpdateError: 'Error while updating the filter',

    RatioRegulationMode: 'Ratio regulation mode',

    FixedTap: 'Fixed tap',

    DeleteRows: 'Delete',

    GenerateTemplateFromFilter: 'Generate from filter',
    GenerateFromFilterError: 'Error while generating template from filter',
    uploadMessage: ' No file selected',

    GeneratePrefilledModel: 'Generate prefilled model',
    RestrictEquipmentList: 'Restrict equipment list',
    CurrentGridState: 'Current grid state',
    ColumnSelectionRequired: 'At least one column must be selected',

    'PrefilledColumn.Conductance': 'Conductance',
    'PrefilledColumn.Susceptance': 'Susceptance',
    'PrefilledColumn.Connected': 'Connected',
    'PrefilledColumn.ConnectionInfo': 'Connection info',
    'PrefilledColumn.WindingVoltages': 'Winding voltages',
    'PrefilledColumn.ActivePowerLimits': 'Active power limits',
    ...
    insertNodeAbove: 'Above',
    insertNodeBelow: 'Below',
    renameNode: 'Rename',
    copyNetworkModificationNode: 'Copy',
    ...
    cutNetworkModificationSubtree: 'Cut',
    cancelCutNetworkModificationSubtree: 'Cancel cut',
    removeNetworkModificationSubtree: 'Remove',
    restoreNodes: 'Restore',
    deleteNodesText:
        '{numberToDelete, plural, =0 {Please select a node to delete} =1 {One node or subtree will be permanently deleted.} other {# nodes or subtrees will be permanently deleted.}}',
    ReorderSubtreeInvalidNotifInfo: 'Subtree order update cancelled (invalid notification infos) !',

    LoadStudyAndParentsInfoError: "An error occurred while loading current study's name and path",
    InvalidNode: 'Node not built',
    NoSpreadsheets: 'You have no spreadsheets, please create one',

    LookForEquipmentField: 'Look for a field',
    EquipmentSchemaPopoverSchema:
        'Opens the list of fields for the equipment associated with the sheet. The list can also be opened by pressing the Shift key on the keyboard twice.',
    FetchingEquipmentSchemaError: 'An error occurred while fetching equipment schema',
    ...
    RegulatingMode: 'Phase regulation mode',
    RegulatingPhase: 'Phase regulating',
    RegulatingValue: 'Current (A) or flow set point (MW)',
    HasLoadTapChangingCapabilities: 'Ratio on-load',
    RegulatingRatio: 'Ratio regulating',
    TargetVPoint: 'Voltage set point (kV)',

    RegulatingMode1: 'Phase regulation mode 1',
    RegulatingPhase1: 'Phase regulating 1',
    RegulatingValue1: 'Current (A) or flow set point (MW) 1',
    HasLoadTapChanging1Capabilities: 'Ratio on-load 1',
    RegulatingRatio1: 'Ratio regulating 1',
    TargetVPoint1: 'Voltage set point (kV) 1',
    RegulatingMode2: 'Phase regulation mode 2',
    RegulatingPhase2: 'Phase regulating 2',
    RegulatingValue2: 'Current (A) or flow set point (MW) 2',
    HasLoadTapChanging2Capabilities: 'Ratio on-load 2',
    RegulatingRatio2: 'Ratio regulating 2',
    TargetVPoint2: 'Voltage set point (kV) 2',
    RegulatingMode3: 'Phase regulation mode 3',
    RegulatingPhase3: 'Phase regulating 3',
    RegulatingValue3: 'Current (A) or flow set point (MW) 3',
    HasLoadTapChanging3Capabilities: 'Ratio on-load 3',
    RegulatingRatio3: 'Ratio regulating 3',
    TargetVPoint3: 'Voltage set point (kV) 3',
    voltageSetpoint: 'Target V (kV)',
    targetV: 'Target V (kV)',
    VoltageSetpointKV: 'Voltage set point (kV)',
    ReactivePowerSetpointMVAR: 'Reactive power set point (Mvar)',
    ...
    generatedNADOpenedInTheGrid: 'The generated network area diagram was opened in the image grid',

    CatalogButtonTooltip: 'Open catalog',
    LineTypesCatalogDialogTitle: 'Define line segments',
    AddSegment: 'Add segment',
    AtLeastOneSegmentNeeded: 'At least one line segment is needed',
    SelectType: 'Type selection',
    SegmentDistance: 'Length',
    [SEGMENT_DISTANCE_MUST_BE_GREATER_THAN_ZERO]: 'The length must be greater than zero',
    SegmentTypeMissing: 'Type missing',
    LineTypesCatalogFetchingError: 'An error occurred while retrieving the line types catalog',
    'lineTypes.resistanceLabel': 'Resistance [Ω]',
    'lineTypes.reactanceLabel': 'Reactance [Ω]',
    'lineTypes.susceptanceLabel': 'Susceptance [μS]',
    'lineTypes.type': 'Type',
    'lineTypes.voltage': 'Voltage [kV]',
    'lineTypes.conductorType': 'Type of conductor',
    'lineTypes.section': 'Section [mm²]',
    'lineTypes.conductorsNumber': 'Number of conductors',
    'lineTypes.circuitsNumber': 'Number of circuits',
    'lineTypes.groundWiresNumber': 'Number of ground wires',
    'lineTypes.linearResistance': 'Linear resistance [Ω/km]',
    'lineTypes.linearReactance': 'Linear reactance [Ω/km]',
    'lineTypes.linearCapacity': 'Linear capacity [F/km]',
    'lineTypes.category.aerial': 'Overhead power lines',
    'lineTypes.category.underground': 'Underground cables',
    'lineTypes.insulator': 'Insulator',
    ...
    undergroundShapeFactors: 'Shape factor',
    undergroundAreas: 'Area',
    'menu.create': 'Create',
    'menu.createMultiple': 'Create multiple equipment',
    'menu.createByTable': 'Create by table',
    'menu.deleteByFilter': 'Delete by filter',
    'menu.modifyMultiple': 'Modify multiple equipment',
    ShuntCompensator: 'Shunt compensator',
    StaticVarCompensator: 'Static var compensator',
    AttachingLines: 'Attaching lines',
    SplittingLines: 'Splitting lines',
    GenerationAndLoad: 'Generation and load',
    cut: 'Cut',
    copy: 'Copy',
    paste: 'Paste',
    restore: 'Restore',
    ...
    AssembleIntoComposite: 'Create a composite modification',
    AssembleIntoCompositeError: 'An error occurred during the creation of the composite modification',
    DefaultCompositeName: 'Composite modification',
    CompositeNestingLimitReached: 'Saving to GridExplore is not possible : would exceed nesting limit ({limit})',
    CompositeAssemblyDepthExceeded:
        'Composite modification creation is not possible : would exceed nesting limit ({limit})',
    diagramConfigCreationMsg: 'Network area diagram created in {directory}',
    diagramConfigUpdateMsg: 'Network area diagram {item} updated',
    diagramConfigCreationError: 'Network area diagram creation error',
    diagramConfigUpdateError: 'Error while updating network area diagram {item}',
    ...
    errUpdateModificationsMsg: 'Error while updating Composite modification {item}',
    ...
    networkRecreationError: 'An error occurred when recreating study network',
    checkNetworkExistenceError: 'An error occurred when checking study network existence',

    deleteNodeConfirmation: '"{nodeName}" will be deleted.',
    deleteSubTreeConfirmation:
        '"{nodeName}" {nodesNumber, plural, =0 {will be deleted.} =1 {and its subtree with one node will be deleted.} other {and its subtree with # nodes will be deleted.}}',

    'withoutunit.ipMin': 'ISC min',
    'withoutunit.ipMax': 'ISC max',
    marginalCost: 'Startup cost',

    'dialog.button.leave': 'Leave',
    'dialog.button.launch': 'Launch',

    Connect: 'Reconnect ?',
    connected1: 'Connected 1',
    connected2: 'Connected 2',
    ConnectedT3WSide1: 'Connected 1',
    ...
    ratedNominalPower: 'Rated nominal power (MVA)',
    ...
    GeneratorsCappings: 'Cappings',
    MonitoredBranches: 'Branches',
    Contingencies: 'Contingencies',
    GenerationStageKind: 'Generation kind',
    GenerationStageFilter: 'Filter',
    PercentMaxP1: 'P1 in Pmax %',
    PercentMaxP2: 'P2 in Pmax %',
    PercentMaxP3: 'P3 in Pmax %',
    StageName: 'Stage to simulate',
    GeneratorsCappingsKind: 'Generation kind',
    GeneratorsCappingsFilter: 'Filter',
    ...
    CoefficientMustBeGreaterOrEqualToZero: 'Coefficient should be greater than or equal to 0',
    CoefficientMustBeLowerOrEqualToOne: 'Coefficient should be less than or equal to 1',
    NoSimulatedStageGiven: 'At least one simulated stage must be given',
    NoGeneratorsFilterGiven: 'At least one generators filter must be given',
    modificationsAlreadyApplied: 'The modifications have already been applied',
    nominalVoltage: 'Nominal voltage (kV)',
    'withoutUnit.nominalV': 'Nominal voltage',
    lowVoltageLimit: 'Low voltage limit (kV)',
    highVoltageLimit: 'High voltage limit (kV)',
    SingleEquipment: 'Single equipment',
    MultipleEquipment: 'Multiple equipment',
    linearShuntCompensators: 'Linear shunt compensators',
    csvExportSensitivityResultError: 'An error occurred when exporting sensitivity results',
    substationCountry: 'Country code',
    ...
    PccMin: 'Pcc min N-1',
    startPccMinError: 'An error occurred while launching the pcc min',
    pccMinError: 'An error occurred when executing the pcc min',
    PccMinResultsError: 'An error occurred when exporting pcc min N-1 results',
    NoFilter: 'No filter',
    NoFolder: 'No folder',
    searchPlaceholder: 'Search',
    searchPlaceholderLog: 'Search in Logs',
    searchPlaceholderLogsTreeStructure: 'Search in tree structure',
    reportLogsPerPage: 'Logs per page',
    ...
    'guidancePopUp.secondVariant': 'Press {symbol} Enter to finish or Esc to cancel.',
    'guidancePopUp.action': 'Close editor',
    generateNad: 'Generate',
    ...
    StateEstimationRunLogicalControls: 'Run logical controls',
    LogicalControlsComputationErrorMsg: 'An error occurred while retrieving the logical controls computation results',
    CriterionType: 'Type',
    Validity: 'Validity',
    Threshold: 'Threshold',
    ...
    LogicalControlsBalances: 'Balances',
    LogicalControlsNonZeroMeasurementsOnDisconnected: 'Non-zero measurements on disconnected',
    LogicalControlsZeroMeasurementsOnConnected: 'Zero measurements on connected',
    LogicalControlsOriginExtremityDeviations: 'Origin/extremity deviations',
    LogicalControlsOutOfBoundsMeasurements: 'Out of bounds measurements',
    LogicalControlsVoltageDeviations: 'Voltage measurement deviations',
    balances: 'Balances',
    nonZeroMeasurementsOnDisconnected: 'Non-zero measurements on disconnected',
    zeroMeasurementsOnConnected: 'Zero measurements on connected',
    originExtremityDeviations: 'Origin/extremity deviations',
    outOfBoundsMeasurements: 'Out of bounds measurements',
    voltageDeviations: 'Voltage measurement deviations',
    VoltageLevelName: 'Voltage level',
    ...
    'MeasurementType.ACTIVE_TRANSIT_ORIGIN': 'Active transit (origin)',
    'MeasurementType.ACTIVE_TRANSIT_EXTREMITY': 'Active transit (extremity)',
    'MeasurementType.REACTIVE_TRANSIT': 'Reactive transit',
    'MeasurementType.REACTIVE_TRANSIT_ORIGIN': 'Reactive transit (origin)',
    'MeasurementType.REACTIVE_TRANSIT_EXTREMITY': 'Reactive transit (extremity)',
    'MeasurementType.ACTIVE_PRODUCTION': 'Active production',
    'MeasurementType.REACTIVE_PRODUCTION': 'Reactive production',
    'MeasurementType.ACTIVE_LOAD': 'Active load',
    'MeasurementType.REACTIVE_LOAD': 'Reactive load',
    StatusType: 'Status type',
    'StatusType.SWITCHING_DEVICE': 'Switching device',
    'StatusType.HVDC_POLES_COUNT': 'HVDC poles count',
    'LimitType.PMIN': 'Pmin',
    'LimitType.PMAX': 'Pmax',
    'LimitType.QMIN': 'Qmin',
    'LimitType.QMAX': 'Qmax',
    OriginMeasurement: 'Origin measurement',
    ExtremityMeasurement: 'Extremity measurement',
    Deviation: 'Deviation',
    ThresholdType: 'Threshold type',
    MinBusbarSection: 'Min busbar section',
    MinBusbarSectionValue: 'Min value',
    MaxBusbarSection: 'Max busbar section',
    MaxBusbarSectionValue: 'Max value',

    chooseCase: 'Select a case',
    addNetwork: 'Add network',
    deleteNetwork: '{count, plural,=0 {Delete network} =1 {Delete 1 network} other {Delete # networks}}',
    ...
    rootNetworkCreated: 'The root network has been created successfully',
    deleteRootNetworkError: 'An error occurred while deleting root networks',
    ...
    'rootNetwork.modificationsInfos':
        'Only modifications in built nodes and their parent nodes will appear in the results.',
    ...
    importCaseFailure: 'Unable to import case',
    networkModificationActivationByRootNetworkError:
        'An error occurred while enabling / disabling modification by root network',
    ...
    StateEstimationParametersAreaInvalidationTabLabel: 'Area invalidation',
    StateEstimationParametersPrincipalObservableZoneLabel: 'Estimation on main observable zone',
    StateEstimationParametersUniquePhaseLabel: 'Unique phase',
    ...
    qmin: 'Min Q',
    qmax: 'Max Q',
    StateEstimationParametersInvalidateLabel: 'Invalidate',
    StateEstimationParametersSubstationFilterLabel: 'Substations',
    StateEstimationParametersAreaInvalidationFilterSelection: 'Substation filters selection',
    StateEstimationParametersInvalidationTypeLabel: 'Invalidation type',
    StateEstimationParametersInvalidationTypeErroneousTopologyPv: 'Erroneous topology PV',
    StateEstimationParametersInvalidationTypeErroneousTopologyPq: 'Erroneous topology PQ',
    StateEstimationParametersInvalidationTypeNotFullyDescribed: 'Not fully described',
    ...
    BalancesAdjustmentCountry: 'Countries',
    BalancesAdjustmentShiftEquipmentType: 'Equipment type',
    BalancesAdjustmentShiftType: 'Shift type',
    BalancesAdjustmentTarget: 'Net position target',
    ...
    subtractLoadFlowBalancing: 'Take into account loadflow balancing when calculating mismatch',
    thresholdNetPosition: 'Net position mismatch threshold',
    loadFlowModification: 'Loadflow modification applied',

    CreateVoltageLevelTopology: 'Adding a busbar',
    diagramLoadingFail: 'An error occurred while loading {diagramName}',
    expand: 'Expand',
    expandAllVoltageLevels: 'Expand all voltage levels',
    addVoltageLevelsFromFilter: 'Add supplementary filter',
    addVoltageLevel: 'Add a voltage level',
    searchVoltageLevelInNad: 'Search voltage level',
    ...
    ClickToReset: 'Click to remove filters',
    RowCounterInfo:
        'Displays the row count for the current spreadsheet. If filters are applied it will display the current filtered row amount, you can remove all filters by then clicking on this button.',
    Switch: 'Switch',
    newSwitchStates: 'New switches closed ',
    ...
    workspace: 'Workspace',
    resetWorkspaceConfirmation: 'Are you sure you want to reset this workspace? All open panels will be closed.',
    renameWorkspace: 'Rename Workspace',
    workspaceName: 'Workspace Name',
    manageWorkspaces: 'Manage workspaces',
    save: 'Save',
    saveWorkspace: 'Save Workspace',
    workspaceReplaceSuccess: 'Workspace replaced successfully',
    workspaceReplaceError: 'Error replacing workspace',
    selectWorkspaceToImport: 'Choose workspace',
    createWorkspaceLabel: 'Create a new workspace',
    replaceWorkspaceLabel: 'Replace an existing workspace',
    workspaceSaveSuccess: 'Workspace saved successfully',
    workspaceUpdateSuccess: 'Workspace replaced successfully',
    workspaceSaveError: 'Error saving workspace',
    workspaceUpdateError: 'Error updating workspace',
    window: 'window',
    windows: 'windows',
    reset: 'Reset',
    history: 'History',
    nadVoltageFilter: 'Voltage',
    nadInfoFilter: 'Information',
    nadInfoActivePowerValue: 'P values',
    nadInfoReactivePowerValue: 'Q values',
    ...
    'tooltip.angle': 'θ (°)',
    'tooltip.generation': 'Generation (MW)',
    'tooltip.load': 'Load (MW)',
    'tooltip.balance': 'Balance (MW)',
    'tooltip.icc': 'Isc (kA)',
    ...
    unbuildAllNodesDialogContent:
        'All built nodes for all root networks as well as their computation results will be deleted',
