...
const messages_en = {
    ...
    LogicalControlsOriginExtremityDeviations: 'Side 1 / side 2 deviations',
    ...
    CsvNameBalances: 'Balances',
    CsvNameNonZeroMeasurementsOnDisconnected: 'Non-zero measurements on disconnected',
    CsvNameZeroMeasurementsOnConnected: 'Zero measurements on connected',
    CsvNameOriginExtremityDeviations: 'Side 1 side 2 deviations',
    CsvNameOutOfBoundsMeasurements: 'Out of bounds measurements',
    CsvNameVoltageDeviations: 'Voltage measurement deviations',
    EquipmentIdentifier: 'Equipment',
    BusIdentifier: 'Bus',
    ...
    'MeasurementType.REACTIVE_TRANSIT_ORIGIN': 'Side 1 reactive transit',
    'MeasurementType.REACTIVE_TRANSIT_EXTREMITY': 'Side 2 reactive transit',
    ...
    'LimitType.QMIN': 'QMIN',
    'LimitType.QMAX': 'QMAX',
    OriginMeasurement: 'Side 1 measurement',
    ExtremityMeasurement: 'Side 2 measurement',
    Deviation: 'Deviation',
    ThresholdType: 'Threshold type',
    MinBusbarSection: 'Min busbar section',
    MinBusbarSectionValue: 'Min busbar section value',
    MaxBusbarSection: 'Max busbar section',
    MaxBusbarSectionValue: 'Max busbar section value',
