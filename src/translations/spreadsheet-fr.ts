...
const spreadsheetFr = {
    ...
    'spreadsheet/custom_column/update_custom_column': 'Modifier colonne personnalisée',
    'spreadsheet/custom_column/delete_custom_column': 'Supprimer colonne personnalisée',
