...
const errors_locale_en = {
    ...
    fetchDefaultLoadFlowProviderError:
        'An error occured when fetching default load flow provider',
    fetchDefaultSecurityAnalysisProviderError:
        'An error occured when fetching default security analysis provider',
    ...
    fetchLoadFlowParametersError:
        'An error occured when fetching the load flow parameters',
    fetchLoadFlowProviderError:
        'An error occured when fetching the load flow provider',
    fetchLoadFlowProvidersError:
        'An error occurred while fetching the load flow providers',
    fetchLoadFlowSpecificParametersError:
        'An error occured when fetching the load flow specific parameters',
    fetchNonEvacuatedEnergyProviderError:
        'An error occured when fetching non evacuated energy provider',
    fetchNonEvacuatedEnergyProvidersError:
        'An error occured when fetching non evacuated energy provider list',
    fetchSecurityAnalysisParametersError:
        'An error occured when fetching the security analysis parameters',
    fetchSecurityAnalysisProviderError:
        'An error occured when fetching security analysis provider',
    fetchSecurityAnalysisProvidersError:
        'An error occured when fetching security analysis provider list',
    fetchSensitivityAnalysisParametersError:
        'An error occured when fetching the sensitivity analysis parameters',
    fetchSensitivityAnalysisProviderError:
        'An error occured when fetching sensitivity analysis provider',
    fetchSensitivityAnalysisProvidersError:
        'An error occured when fetching sensitivity analysis provider list',
    updateLoadFlowParametersError:
        'An error occurred while updating the load flow parameters',
    updateLoadFlowProviderError:
        'An error occurred while updating the load flow provider',
    updateSecurityAnalysisParametersError:
        'An error occurred while updating the security analysis parameters',
    updateSecurityAnalysisProviderError:
        'An error occured when updating security analysis provider',
