...
const network_modifications_locale_fr = {
    ...
    'network_modifications.EQUIPMENT_DELETION':
        'Suppression de {computedLabel}',
    'network_modifications.BY_FILTER_DELETION':
        'Suppression par filtre ({computedLabel})',
    'network_modifications.SUBSTATION_CREATION':
        'Création du site {computedLabel}',
    'network_modifications.SUBSTATION_MODIFICATION':
        'Modification du site {computedLabel}',
    'network_modifications.VOLTAGE_LEVEL_CREATION':
        'Création du poste {computedLabel}',
    'network_modifications.VOLTAGE_LEVEL_MODIFICATION':
        'Modification du poste {computedLabel}',
    'network_modifications.LINE_SPLIT_WITH_VOLTAGE_LEVEL':
        "Création d'une coupure {computedLabel}",
    'network_modifications.LINE_ATTACH_TO_VOLTAGE_LEVEL':
        "Création d'un piquage {computedLabel}",
    'network_modifications.LINES_ATTACH_TO_SPLIT_LINES':
        'Passage de piquage en coupure {computedLabel}',
    'network_modifications.LOAD_SCALING':
        'Variation plan de consommation {computedLabel}',
    'network_modifications.DELETE_VOLTAGE_LEVEL_ON_LINE':
        "Suppression d'une coupure {computedLabel}",
    'network_modifications.DELETE_ATTACHING_LINE':
        "Suppression d'un piquage {computedLabel}",
    'network_modifications.LOAD_CREATION':
        'Création de la charge {computedLabel}',
    'network_modifications.LOAD_MODIFICATION':
        'Modification de la charge {computedLabel}',
    'network_modifications.BATTERY_CREATION':
        'Création de batterie {computedLabel}',
    'network_modifications.BATTERY_MODIFICATION':
        'Modification de batterie {computedLabel}',
    'network_modifications.GENERATOR_CREATION':
        'Création du générateur {computedLabel}',
    'network_modifications.GENERATOR_MODIFICATION':
        'Modification du générateur {computedLabel}',
    'network_modifications.LINE_CREATION':
        'Création de la ligne {computedLabel}',
    'network_modifications.LINE_MODIFICATION':
        'Modification de la ligne {computedLabel}',
    ...
    'network_modifications.VSC_MODIFICATION': 'Modification du vsc {computedLabel}',
    ...
    'network_modifications.creatingModification':
        'Création de la modification en cours ...',
    ...
    'network_modifications.GENERATION_DISPATCH':
        'Démarrage de groupes {computedLabel}',
    'network_modifications.VOLTAGE_INIT_MODIFICATION':
        'Initialisation du plan de tension {computedLabel}',
    'network_modifications.TABULAR_MODIFICATION':
        'Modification tabulaire - {computedLabel}',
    'network_modifications.tabular.GENERATOR_MODIFICATION':
        'modifications de générateurs',
    ...
    'network_modifications.tabular.SHUNT_COMPENSATOR_MODIFICATION':
        'modifications de MCS linéaires',
    'network_modifications.tabular.SUBSTATION_MODIFICATION':
        'modifications de sites',
    'network_modifications.TABULAR_CREATION':
        'Création tabulaire - {computedLabel}',
    'network_modifications.tabular.GENERATOR_CREATION':
        'créations de générateurs',
};
