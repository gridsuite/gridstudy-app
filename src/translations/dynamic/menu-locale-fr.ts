...
const menu_locale_fr = {
    ...
    DisconnectHvdcLine: 'Déclencher la ligne Hvdc',
    ...
    TripHvdcLine: 'Déclencher la Hvdc ligne',
    ...
    UnableToLockoutHvdcLine: 'Impossible de consigner la Hvdc ligne',
    ...
    UnableToTripHvdcLine: 'Impossible de déclencher la Hvdc ligne',
};
