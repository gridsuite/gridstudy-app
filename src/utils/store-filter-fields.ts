...
//Loadflow result filter store fields
export const LOADFLOW_RESULT_STORE_FIELD = 'loadflowResultFilter';
...
//Security analysis result filter store fields
...
//Sensitivity analysis result filter store fields
...
//Shortcircuit analysis result filter store fields
...
//Dynamic simulation result filter store fields
