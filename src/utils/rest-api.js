...
export function createLine(
    ...
    return backendFetchText(createLineUrl, {
        ...
        body: JSON.stringify({
            ...
            position1: {
                label: connectionName1,
                order: connectionPosition1,
                direction: connectionDirection1,
            },
            position2: {
                label: connectionName2,
                order: connectionPosition2,
                direction: connectionDirection2,
            },
        }),
    });
}
