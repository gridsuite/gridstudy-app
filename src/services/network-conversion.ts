...
const PREFIX_NETWORK_CONVERSION_QUERIES = PREFIX_STUDY_QUERIES + '/v1/network-conversion';
...
export function getCaseImportParameters(caseUuid: UUID): Promise<GetCaseImportParametersReturn> {
    ...
    const getExportFormatsUrl = PREFIX_NETWORK_CONVERSION_QUERIES + '/cases/' + caseUuid + '/import-parameters';
