...
export function modifyLine({
    ...
    return backendFetchText(modifyLineUrl, {
        ...
        body: JSON.stringify({
            ...
            selectedOperationalLimitsGroup1: toModificationOperation(selectedLimitsGroup1),
            selectedOperationalLimitsGroup2: toModificationOperation(selectedLimitsGroup2),
