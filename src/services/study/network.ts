...
import { EquipmentType, ExtendedEquipmentTypes, type GsLang, type Identifiable } from '@gridsuite/commons-ui';
...
export function fetchNetworkElementInfos(
    ...
    elementType: EquipmentType | EQUIPMENT_TYPES | ExtendedEquipmentTypes,
    infoType: string,
    elementId: string,
    inUpstreamBuiltParentNode: boolean
) {
