...
export function createLine(
    ...
    return backendFetchText(createLineUrl, {
        ...
        body: JSON.stringify({
            ...
            selectedLimitGroup1: selectedLimitGroup1,
            selectedLimitGroup2: selectedLimitGroup2,
...
export function modifySubstation({ studyUuid, nodeUuid, modificationUuid = undefined, id, name, country, properties }) {
