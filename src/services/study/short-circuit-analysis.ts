...
import { getStudyUrl, getStudyUrlWithNodeUuidAndRootNetworkUuid, PREFIX_STUDY_SERVER_QUERIES } from './index';
import {
...
const PREFIX_SHORTCIRCUIT_SERVER_QUERIES = PREFIX_STUDY_SERVER_QUERIES + '/v1/shortcircuit';

export function getShortCircuitUrl() {
    return `${PREFIX_SHORTCIRCUIT_SERVER_QUERIES}/`;
}
