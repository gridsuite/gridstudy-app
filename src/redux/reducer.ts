...
const initialState: AppState = {
    ...
    computingStatus: {
        [ComputingType.LOAD_FLOW]: RunningStatus.UNKNOWN,
        [ComputingType.SECURITY_ANALYSIS]: RunningStatus.UNKNOWN,
        [ComputingType.SENSITIVITY_ANALYSIS]: RunningStatus.UNKNOWN,
        [ComputingType.SHORT_CIRCUIT]: RunningStatus.UNKNOWN,
        [ComputingType.SHORT_CIRCUIT_ONE_BUS]: RunningStatus.UNKNOWN,
        [ComputingType.DYNAMIC_SIMULATION]: RunningStatus.UNKNOWN,
        [ComputingType.DYNAMIC_SECURITY_ANALYSIS]: RunningStatus.UNKNOWN,
        [ComputingType.DYNAMIC_MARGIN_CALCULATION]: RunningStatus.UNKNOWN,
        [ComputingType.VOLTAGE_INITIALIZATION]: RunningStatus.UNKNOWN,
        [ComputingType.STATE_ESTIMATION]: RunningStatus.UNKNOWN,
        [ComputingType.PCC_MIN]: RunningStatus.UNKNOWN,
    },
