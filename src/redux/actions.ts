...
export type UpdateEquipmentsAction = Readonly<
    Action<typeof UPDATE_EQUIPMENTS>
> & {
...
export type DeleteEquipmentsAction = Readonly<
    Action<typeof DELETE_EQUIPMENTS>
> & {
    equipments: EquipmentToDelete[];
};
export function deleteEquipments(
    equipments: EquipmentToDelete[]
): DeleteEquipmentsAction {
    return {
...
export type ResetEquipmentsByTypesAction = Readonly<
    Action<typeof RESET_EQUIPMENTS_BY_TYPES>
> & {
    equipmentTypes: SpreadsheetEquipmentType[];
};
export function resetEquipmentsByTypes(
    equipmentTypes: SpreadsheetEquipmentType[]
): ResetEquipmentsByTypesAction {
    return {
...
export type ResetEquipmentsPostLoadflowAction = Readonly<
    Action<typeof RESET_EQUIPMENTS_POST_LOADFLOW>
>;
...
export type MapEquipmentsCreatedAction = Readonly<
    Action<typeof MAP_EQUIPMENTS_CREATED>
> & {
...
export type NetworkModificationTreeNodeAddedAction = Readonly<
    Action<typeof NETWORK_MODIFICATION_TREE_NODE_ADDED>
> & {
...
export type NetworkModificationTreeNodeMovedAction = Readonly<
    Action<typeof NETWORK_MODIFICATION_TREE_NODE_MOVED>
> & {
    networkModificationTreeNode: CurrentTreeNode;
    parentNodeId: string;
    insertMode: NodeInsertModes;
...
export type NetworkModificationHandleSubtreeAction = Readonly<
    Action<typeof NETWORK_MODIFICATION_HANDLE_SUBTREE>
> & {
...
export type SelectComputedLanguageAction = Readonly<
...
export type SetParamsLoadedAction = Readonly<
    Action<typeof SET_PARAMS_LOADED>
> & {
    [PARAMS_LOADED]: true;
};
...
export type RemoveSelectedCaseAction = Readonly<
    Action<typeof REMOVE_SELECTED_CASE>
>;
...
export function selectCenterLabelState(
    centerLabel: boolean
): CenterLabelAction {
...
export function selectDiagonalLabelState(
...
export function selectLineFullPathState(
...
export type LineParallelPathAction = Readonly<
    Action<typeof LINE_PARALLEL_PATH>
> & {
    [PARAM_LINE_PARALLEL_PATH]: boolean;
};
export function selectLineParallelPathState(
...
export function selectLineFlowMode(
...
export function selectFluxConvention(
    fluxConvention: FluxConventions
): FluxConventionAction {
    return { type: FLUX_CONVENTION, [PARAM_FLUX_CONVENTION]: fluxConvention };
}

export const ENABLE_DEVELOPER_MODE = 'ENABLE_DEVELOPER_MODE';
export type EnableDeveloperModeAction = Readonly<
    Action<typeof ENABLE_DEVELOPER_MODE>
> & {
...
export type LineFlowColorModeAction = Readonly<
    Action<typeof LINE_FLOW_COLOR_MODE>
> & {
    [PARAM_LINE_FLOW_COLOR_MODE]: LineFlowColorMode;
};
export function selectLineFlowColorMode(
...
export type LineFlowAlertThresholdAction = Readonly<
    Action<typeof LINE_FLOW_ALERT_THRESHOLD>
> & {
    [PARAM_LINE_FLOW_ALERT_THRESHOLD]: number;
};
export function selectLineFlowAlertThreshold(
...
export function selectLimitReduction(
...
export type LimitReductionModifiedAction = Readonly<
    Action<typeof LIMIT_REDUCTION_MODIFIED>
> & {
    limitReductionModified: boolean;
};
export function limitReductionModified(
    limitReductionModified: boolean
): LimitReductionModifiedAction {
    return {
...
export function setMapDataLoading(
    mapDataLoading: boolean
): MapDataLoadingAction {
    return {
...
export type MapManualRefreshAction = Readonly<
    Action<typeof MAP_MANUAL_REFRESH>
> & {
    [PARAM_MAP_MANUAL_REFRESH]: boolean;
};
export function selectMapManualRefresh(
...
export type ResetMapReloadedAction = Readonly<
    Action<typeof RESET_MAP_RELOADED>
>;
...
export type MapEquipmentsInitializedAction = Readonly<
    Action<typeof MAP_EQUIPMENTS_INITIALIZED>
> & {
    newValue: boolean;
};
export function setMapEquipementsInitialized(
    newValue: boolean
): MapEquipmentsInitializedAction {
    return {
...
export type SubstationLayoutAction = Readonly<
    Action<typeof SUBSTATION_LAYOUT>
> & {
    [PARAM_SUBSTATION_LAYOUT]: SubstationLayout;
};
export function selectSubstationLayout(
...
export type ComponentLibraryAction = Readonly<
    Action<typeof COMPONENT_LIBRARY>
> & {
    [PARAM_COMPONENT_LIBRARY]: unknown;
};
export function selectComponentLibrary(
...
export type SetFullscreenDiagramAction = Readonly<
    Action<typeof SET_FULLSCREEN_DIAGRAM>
> &
    (
        | { diagramId: null }
        | {
...
export type ChangeDisplayedColumnsNamesAction = Readonly<
    Action<typeof CHANGE_DISPLAYED_COLUMNS_NAMES>
> & {
    displayedColumnsNamesParams: ColumnName[];
};
export function changeDisplayedColumns(
    displayedColumnsParams: ColumnName[]
): ChangeDisplayedColumnsNamesAction {
    return {
...
export type ChangeLockedColumnsNamesAction = Readonly<
    Action<typeof CHANGE_LOCKED_COLUMNS_NAMES>
> & {
    lockedColumnsNamesParams: ColumnName[];
};
export function changeLockedColumns(
    lockedColumnsParams: ColumnName[]
): ChangeLockedColumnsNamesAction {
    return {
...
export type ChangeReorderedColumnsAction = Readonly<
    Action<typeof CHANGE_REORDERED_COLUMNS>
> & {
    reorderedColumnsParams: ColumnName[];
};
export function changeReorderedColumns(
    reorderedColumnsParams: ColumnName[]
): ChangeReorderedColumnsAction {
    return {
...
export type FavoriteContingencyListsAction = Readonly<
    Action<typeof FAVORITE_CONTINGENCY_LISTS>
> & {
...
export type CurrentTreeNodeAction = Readonly<
    Action<typeof CURRENT_TREE_NODE>
> & {
    currentTreeNode: CurrentTreeNode;
};
export function setCurrentTreeNode(
    currentTreeNode: CurrentTreeNode
): CurrentTreeNodeAction {
    return {
...
export type SetModificationsDrawerOpenAction = Readonly<
    Action<typeof SET_MODIFICATIONS_DRAWER_OPEN>
> & {
    isModificationsDrawerOpen: boolean;
};
export function setModificationsDrawerOpen(
    isModificationsDrawerOpen: boolean
): SetModificationsDrawerOpenAction {
    return {
...
export type SetEventScenarioDrawerOpenAction = Readonly<
    Action<typeof SET_EVENT_SCENARIO_DRAWER_OPEN>
> & {
    isEventScenarioDrawerOpen: boolean;
};
export function setEventScenarioDrawerOpen(
    isEventScenarioDrawerOpen: boolean
): SetEventScenarioDrawerOpenAction {
    return {
...
export type CenterOnSubstationAction = Readonly<
    Action<typeof CENTER_ON_SUBSTATION>
> & {
    centerOnSubstation: { to: unknown };
};
export function centerOnSubstation(
    substationId: unknown
): CenterOnSubstationAction {
    return {
...
export type AddNotificationAction = Readonly<
    Action<typeof ADD_NOTIFICATION>
> & {
...
export type RemoveNotificationByNodeAction = Readonly<
    Action<typeof REMOVE_NOTIFICATION_BY_NODE>
> & {
    notificationIds: UnknownArray;
};
export function removeNotificationByNode(
    notificationIds: UnknownArray
): RemoveNotificationByNodeAction {
    return {
...
export type SetModificationsInProgressAction = Readonly<
    Action<typeof SET_MODIFICATIONS_IN_PROGRESS>
> & {
    isModificationsInProgress: boolean;
};
export function setModificationsInProgress(
    isModificationsInProgress: boolean
): SetModificationsInProgressAction {
    return {
...
export type SetStudyDisplayModeAction = Readonly<
    Action<typeof SET_STUDY_DISPLAY_MODE>
> & {
    studyDisplayMode: StudyDisplayMode;
};
export function setStudyDisplayMode(
    studyDisplayMode: StudyDisplayMode
): SetStudyDisplayModeAction {
    return {
...
export type MinimizeDiagramAction = Readonly<
    Action<typeof MINIMIZE_DIAGRAM>
> & {
    id: string;
    svgType: DiagramType;
};
export function minimizeDiagram(
    id: string,
    svgType: DiagramType
): MinimizeDiagramAction {
    return {
...
export type TogglePinDiagramAction = Readonly<
    Action<typeof TOGGLE_PIN_DIAGRAM>
> & {
    id: string;
    svgType: DiagramType;
};
export function togglePinDiagram(
    id: string,
    svgType: DiagramType
): TogglePinDiagramAction {
    return {
...
export type StopDiagramBlinkAction = Readonly<
    Action<typeof STOP_DIAGRAM_BLINK>
>;
...
export type ResetNetworkAreaDiagramDepthAction = Readonly<
    Action<typeof RESET_NETWORK_AREA_DIAGRAM_DEPTH>
>;
...
export type IncrementNetworkAreaDiagramDepthAction = Readonly<
    Action<typeof INCREMENT_NETWORK_AREA_DIAGRAM_DEPTH>
>;
...
export type DecrementNetworkAreaDiagramDepthAction = Readonly<
    Action<typeof DECREMENT_NETWORK_AREA_DIAGRAM_DEPTH>
>;
...
export function setNetworkAreaDiagramNbVoltageLevels(
    nbVoltageLevels: number
): NetworkAreaDiagramNbVoltageLevelsAction {
    return {
...
export type SetComputingStatusAction = Readonly<
    Action<typeof SET_COMPUTING_STATUS>
> & {
...
export type SetComputationStartingAction = Readonly<
    Action<typeof SET_COMPUTATION_STARTING>
> & {
    computationStarting: boolean;
};
export function setComputationStarting(
    computationStarting: boolean
): SetComputationStartingAction {
    return {
...
export type SetStudyIndexationStatusAction = Readonly<
    Action<typeof SET_STUDY_INDEXATION_STATUS>
> & {
    studyIndexationStatus: StudyIndexationStatus;
};
export function setStudyIndexationStatus(
    studyIndexationStatus: StudyIndexationStatus
): SetStudyIndexationStatusAction {
    return {
...
export type SetOptionalServicesAction = Readonly<
    Action<typeof SET_OPTIONAL_SERVICES>
> & {
    optionalServices: IOptionalService[];
};
export function setOptionalServices(
    optionalServices: IOptionalService[]
): SetOptionalServicesAction {
    return {
...
export type AddToRecentGlobalFiltersAction = Readonly<
    Action<typeof ADD_TO_RECENT_GLOBAL_FILTERS>
> & {
    globalFilters: Filter[];
};
export function addToRecentGlobalFilters(
    globalFilters: Filter[]
): AddToRecentGlobalFiltersAction {
    return {
...
export type SetLastCompletedComputationAction = Readonly<
    Action<typeof SET_LAST_COMPLETED_COMPUTATION>
> & {
...
export type LoadflowResultFilterAction = Readonly<
    Action<typeof LOADFLOW_RESULT_FILTER>
> & {
...
export type SecurityAnalysisResultFilterAction = Readonly<
    Action<typeof SECURITY_ANALYSIS_RESULT_FILTER>
> & {
...
export type SensitivityAnalysisResultFilterAction = Readonly<
    Action<typeof SENSITIVITY_ANALYSIS_RESULT_FILTER>
> & {
...
export type ShortcircuitAnalysisResultFilterAction = Readonly<
    Action<typeof SHORTCIRCUIT_ANALYSIS_RESULT_FILTER>
> & {
...
export type DynamicSimulationResultFilterAction = Readonly<
    Action<typeof DYNAMIC_SIMULATION_RESULT_FILTER>
> & {
...
export type SpreadsheetFilterAction = Readonly<
    Action<typeof SPREADSHEET_FILTER>
> & {
