...
export const getLocalStorageUseName = () =>
    getLocalStorageBoolean(LOCAL_STORAGE_USE_NAME_KEY);
...
export const getLocalStorageCenterLabel = () =>
    getLocalStorageBoolean(LOCAL_STORAGE_CENTER_LABEL_KEY);
...
export const getLocalStorageDiagonalLabel = () =>
    getLocalStorageBoolean(LOCAL_STORAGE_DIAGONAL_LABEL_KEY);
...
export const getLocalStorageTopologicalColoring = () =>
    getLocalStorageBoolean(LOCAL_STORAGE_TOPOLOGICAL_COLORING_KEY);

export const saveLocalStorageTopologicalColoring = (topologicalColoring) => {
    localStorage.setItem(
        LOCAL_STORAGE_TOPOLOGICAL_COLORING_KEY,
        topologicalColoring
    );
};
...
export const getLocalStorageLineFullPath = () =>
    getLocalStorageBoolean(LOCAL_STORAGE_LINE_FULL_PATH_KEY);
