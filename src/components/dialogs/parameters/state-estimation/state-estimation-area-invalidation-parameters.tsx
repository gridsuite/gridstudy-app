...
import { AREA_INVALIDATIONS, FILTER, INVALIDATE, INVALIDATION_TYPE } from '../../../utils/field-constants';
...
export const StateEstimationAreaInvalidationParameters: FunctionComponent = () => {
    const intl = useIntl();
        ...
        return [
            {
                ...
                dataTestId: 'SubstationAreaInvalidationInvalidateInput',
            },
            {
                label: intl.formatMessage({ id: 'StateEstimationParametersSubstationFilterLabel' }),
                dataKey: FILTER,
                initialValue: [],
                editable: true,
                ...
                titleId: 'StateEstimationParametersAreaInvalidationFilterSelection',
                dataTestId: 'SubstationAreaInvalidationFilterInput',
            ...
            },
            {
                ...
                dataTestId: 'SubstationAreaInvalidationInvalidationTypeInput',
            },
        ] satisfies DndColumn[];
    }, [intl]);
    ...
    return (
        <DndTable
            ...
            rowDataTestId="SubstationAreaInvalidationLine"
        />
    );
};
