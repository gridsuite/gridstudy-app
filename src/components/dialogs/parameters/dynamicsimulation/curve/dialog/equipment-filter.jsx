...
const EquipmentFilter = forwardRef(({ equipmentType: initialEquipmentType, onChangeEquipmentType }, ref) => {
    ...
    }, [studyUuid, currentNode.id, equipmentType, selectedVoltageLevelIds, selectedCountries, selectedNominalVoltages]);
