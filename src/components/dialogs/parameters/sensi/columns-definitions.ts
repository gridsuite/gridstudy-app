...
const PSTS_EQUIPMENT_TYPES = [EQUIPMENT_TYPES.TWO_WINDINGS_TRANSFORMER];

const MONITORED_VOLTAGE_LEVELS_EQUIPMENT_TYPES = [EQUIPMENT_TYPES.VOLTAGE_LEVEL];
const INJECTIONS_EQUIPMENT_TYPES = [EQUIPMENT_TYPES.GENERATOR, EQUIPMENT_TYPES.LOAD];
...
const HVDC_EQUIPMENT_TYPES = [EQUIPMENT_TYPES.HVDC_LINE];
