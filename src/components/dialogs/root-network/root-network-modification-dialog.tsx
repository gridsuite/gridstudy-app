...
interface RootNetworkModificationDialogProps {
...
const RootNetworkModificationDialog: React.FC<RootNetworkModificationDialogProps> = ({
    editableRootNetwork,
    open,
    onSave,
    onClose,
    ...
    // Reset the form values when editableRootNetwork is available
    useEffect(() => {
