...
export interface ActivePowerControlFormInfos {
    participate?: boolean | null;
    droop?: number | null;
}

export const getFrequencyRegulationEmptyFormData = (isEquipmentModification = false) => ({
    [FREQUENCY_REGULATION]: isEquipmentModification ? null : false,
    [DROOP]: null,
});

export const getFrequencyRegulationSchema = (isEquipmentModification = false) => ({
