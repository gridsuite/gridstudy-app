...
interface SetPointsFormProps {
    previousValuesTargetP?: number;
    previousValuesTargetQ?: number;
}

export default function SetPointsForm({ previousValuesTargetP, previousValuesTargetQ }: Readonly<SetPointsFormProps>) {
    const activePowerSetPointField = (
        <FloatInput
            name={ACTIVE_POWER_SET_POINT}
            label={'ActivePowerText'}
            adornment={ActivePowerAdornment}
            previousValue={previousValuesTargetP}
            clearable={true}
        />
    );
    ...
    const reactivePowerSetPointField = (
        <FloatInput
            ...
            previousValue={previousValuesTargetQ}
            clearable={true}
        />
    );
