...
import { LineCreationDialogTab } from "../line/creation/line-creation-dialog";
          ...
          <Grid container>
              ...
              >
                  ...
                  <Tab
                    ...
                    className={getTabClass(VSC_CREATION_TABS.CONVERTER_STATION_1)}
                  />
                  <Tab
                    label={<FormattedMessage id="converterStation2" />}
                    className={getTabClass(VSC_CREATION_TABS.CONVERTER_STATION_2)}
                  />
              </Tabs>
          </Grid>
      </>
