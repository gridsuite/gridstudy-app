    ...
    const onSubmit = useCallback(
        (line) => {
            ...
            onCreateLine({
                ...
                limitsGroups1: sanitizeLimitsGroups(limits[LIMITS_GROUP_1]),
                limitsGroups2: sanitizeLimitsGroups(limits[LIMITS_GROUP_2]),
                selectedLimitGroup1: limits[SELECTED_LIMITS_GROUP_1],
                selectedLimitGroup2: limits[SELECTED_LIMITS_GROUP_2],
                isUpdate: !!editData,
