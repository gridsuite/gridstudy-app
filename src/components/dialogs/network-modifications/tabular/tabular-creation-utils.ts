...
export const TABULAR_CREATION_FIELDS: TabularFields = {
    GENERATOR: [
        ...
        { id: FieldConstants.MIN_Q, required: false, type: NUMBER },
        { id: FieldConstants.MAX_Q, required: false, type: NUMBER },
        ...
        { id: FieldConstants.PLANNED_ACTIVE_POWER_SET_POINT, required: false, type: NUMBER },
        { id: FieldConstants.MARGINAL_COST, required: false, type: NUMBER },
        { id: FieldConstants.PLANNED_OUTAGE_RATE, required: false, type: NUMBER },
        { id: FieldConstants.FORCED_OUTAGE_RATE, required: false, type: NUMBER },
    ],
    LOAD: [
        { id: EQUIPMENT_ID, required: true },
        { id: EQUIPMENT_NAME, required: false },
