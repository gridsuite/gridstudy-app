...
export const TABULAR_MODIFICATION_FIELDS: TabularFields = {
    ...
    GENERATOR: [
        ...
        { id: RATED_S, type: NUMBER },
        { id: FieldConstants.MIN_Q, type: NUMBER },
        { id: FieldConstants.MAX_Q, type: NUMBER },
        ...
        { id: FieldConstants.PLANNED_ACTIVE_POWER_SET_POINT, type: NUMBER },
        { id: FieldConstants.MARGINAL_COST, type: NUMBER },
        { id: FieldConstants.PLANNED_OUTAGE_RATE, type: NUMBER },
        { id: FieldConstants.FORCED_OUTAGE_RATE, type: NUMBER },
    ],
    LOAD: [
        { id: EQUIPMENT_ID },
        { id: FieldConstants.EQUIPMENT_NAME },
