...
const BatteryCreationForm = ({ studyUuid, currentNode, rootNetworkUuid }) => {
    const voltageLevelOptions = useVoltageLevelsListInfos(studyUuid, currentNode.id,rootNetworkUuid);
