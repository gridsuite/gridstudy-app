        ...
        <Grid container item>
            <Tabs value={tabIndex} onChange={(event, newValue) => setTabIndex(newValue)}>
                <Tab
                    ...
                    sx={getTabStyle(tabIndexesWithError, LccDialogTab.HVDC_LINE_TAB)}
                />
                <Tab
                    label={<FormattedMessage id="converterStation1" />}
                    sx={getTabStyle(tabIndexesWithError, LccDialogTab.CONVERTER_STATION_1)}
                />
                <Tab
                    label={<FormattedMessage id="converterStation2" />}
                    sx={getTabStyle(tabIndexesWithError, LccDialogTab.CONVERTER_STATION_2)}
                />
            </Tabs>
        </Grid>
    );
