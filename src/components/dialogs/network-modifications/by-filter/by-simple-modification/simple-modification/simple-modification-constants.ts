...
export const EQUIPMENTS_FIELDS = {
    [EQUIPMENT_TYPES.SUBSTATION]: [FIELD_OPTIONS.PROPERTY],
    ...
    [EQUIPMENT_TYPES.LINE]: [FIELD_OPTIONS.PROPERTY],
    ...
    [EQUIPMENT_TYPES.THREE_WINDINGS_TRANSFORMER]: [FIELD_OPTIONS.PROPERTY],
    ...
    [EQUIPMENT_TYPES.STATIC_VAR_COMPENSATOR]: [FIELD_OPTIONS.PROPERTY],
    [EQUIPMENT_TYPES.HVDC_LINE]: [FIELD_OPTIONS.PROPERTY],
};
