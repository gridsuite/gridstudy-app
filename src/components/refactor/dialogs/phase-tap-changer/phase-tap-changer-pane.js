...
const PhaseTapChangerPane = (props) => {
    ...
    const { fields: stepsField, append } = useFieldArray({
        name: 'steps',
        control: control,
    });

    const lowTapPositionWatcher = watch('lowTapPosition');
    const highTapPositionWatcher = watch('highTapPosition');

    console.log('STEEEEEPS', stepsField);
        ...
        return [
            {
                ...
                dataKey: 'tap',
                maxWidth: 200,
                editor: ReactHookFormIntegerNumberTextField,
                name: 'index',
            },
            {
                label: intl
                ...
                id: 'resistance',
                dataKey: 'resistance',
                editor: ReactHookFormFloatNumberTextField,
                name: 'r',
            },
            {
                label: intl
                    ...
                    <>
                        <div className={classes.tableCell}>
                            <Editor
                                ...
                                //inputProps={{ style }}
                                name={`steps[${rowData.rowIndex}].${COLUMNS_DEFINITIONS[index].name}`}
                                control={control}
                                label="test"
                                type="Number"
                                size={'small'}
    ...
    const click = () => {
        console.log('CLICKED');
        const range = [];
        for (let i = lowTapPositionWatcher; i < highTapPositionWatcher; i++) {
            range.push(i);
        }
                ...
                >
                    <Grid item xs={10}>
                        <VirtualizedTable
                            ...
                            //TODO : useArrayFieldKey key={generateTableKey()}
                        />
                    </Grid>
