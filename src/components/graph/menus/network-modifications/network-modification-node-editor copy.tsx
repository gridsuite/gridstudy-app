...
//     modificationsUuids: null,
//     networkModificationCopyInfo: {
//         originStudyUuid: null,
//         originNodeUuid: null,
//         copyType: null,
//     },
// };
...
//                 dispatch(setModificationsSelectionForCopy(noModificationsSelectionForCopy as any));
//                 snackInfo({
...
//                     event.data.networkModificationCopyInfo.originStudyUuid,
//                     event.data.networkModificationCopyInfo.originNodeUuid,
//                     event.data.networkModificationCopyInfo.copyType
//                 );
//             }
//         };
//         return broadcast;
...
//         dispatchModificationsSelectionForCopy(studyUuid, nodeId, CopyType.NODE_COPY);
...
//         nodeId
//             ? dispatchModificationsSelectionForCopy(studyUuid, nodeId, CopyType.NODE_CUT)
...
//         console.info('node with id ' + nodeId + ' from study ' + studyUuid + ' selected for copy');
//         isInitiatingCopyTab.current = true;
//         dispatchModificationsSelectionForCopy(studyUuid, nodeId, CopyType.SUBTREE_COPY);
//         broadcastChannel.postMessage({
//             sourceStudyUuid: studyUuid,
//             nodeId: nodeId,
...
//         nodeId
//             ? dispatchModificationsSelectionForCopy(studyUuid, nodeId, CopyType.SUBTREE_CUT)
//             : dispatch(setModificationsSelectionForCopy(noModificationsSelectionForCopy));
//     };
...
//     const [copiedModifications, setCopiedModifications] = useState<UUID[]>([]); // replacé par le useSelector
//     const [copyInfos, setCopyInfos] = useState<NetworkModificationCopyInfo | null>(null); // inclus dans selectionForCopy
//     const copyInfosRef = useRef<NetworkModificationCopyInfo | null>();
//     copyInfosRef.current = copyInfos;

//     const selectionForCopy = useSelector((state: AppState) => state.modificationsSelectionForCopy);
//     const modificationsSelectionForCopyRef = useRef<ModificationsSelectionForCopy>();
//     modificationsSelectionForCopyRef.current = selectionForCopy;
...
//         modificationsSelectionForCopyRef.current.modificationsUuids = selectedModificationsIds();
//         modificationsSelectionForCopyRef.current.copyType = NetworkModificationCopyType.MOVE;
//         modificationsSelectionForCopyRef.current.copyInfos.originNodeUuid = currentNode.id;
//         modificationsSelectionForCopyRef.current.copyInfos.originStudyUuid = studyUuid;
...
//         modificationsSelectionForCopyRef.current.modificationsUuids = selectedModificationsIds();
//         modificationsSelectionForCopyRef.current.copyInfos.copyType = NetworkModificationCopyType.COPY;
//         modificationsSelectionForCopyRef.current.copyInfos.originNodeUuid = currentNode.id;
//         modificationsSelectionForCopyRef.current.copyInfos.originStudyUuid = studyUuid;
//         // setCopiedModifications(selectedModificationsIds());
//         // setCopyInfos({
...
//         //     originNodeUuid: currentNode?.id,
//         //     //originStudyUuid: currentStudy?.id,
//         // });
//     }, [currentNode?.id, selectedModificationsIds, studyUuid]);

//     const doPasteModifications = useCallback(() => {
//         if (!modificationsSelectionForCopyRef.current.copyInfos || !studyUuid || !currentNode?.id) {
//             return;
//         }
//         if (modificationsSelectionForCopyRef.current.copyInfos.copyType === NetworkModificationCopyType.MOVE) {
//             copyOrMoveModifications(
//                 studyUuid,
//                 currentNode.id,
//                 modificationsSelectionForCopyRef.current.modificationsUuids,
//                 modificationsSelectionForCopyRef.current.copyInfos
//             )
//                 .then(() => {
...
//             });
//         }
//     }, [studyUuid, currentNode?.id, cleanClipboard, snackError]);
...
//         setSelectedNetworkModifications(selectedRows); // useselector ?
//     };
