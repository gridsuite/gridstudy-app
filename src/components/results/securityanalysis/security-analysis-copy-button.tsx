 ...
 * Values themselves (dates, numbers with decimal comma, translated enums) are left untouched.
 */
...
export const SecurityAnalysisCopyButton: FunctionComponent<SecurityAnalysisCopyButtonProps> = ({
    ...
    return (
        <Tooltip title={intl.formatMessage({ id: isCopySuccessful ? 'copiedToClipboard' : 'copyToClipboard' })}>
            <span>
                <IconButton onClick={handleCopy} disabled={disabled || isCopyLoading} size="small">
                    {isCopySuccessful ? (
