...
export const NOMINAL_VOLTAGE_ONE_SIDED_EQUIPMENTS = [
...
export const NOMINAL_VOLTAGE_TWO_SIDED_EQUIPMENTS = [
...
export const NOMINAL_VOLTAGE_THREE_SIDED_EQUIPMENTS = [EQUIPMENT_TYPES.THREE_WINDINGS_TRANSFORMER];

export const COUNTRY_ONE_SIDED_EQUIPMENTS = [
    EQUIPMENT_TYPES.SUBSTATION,
    EQUIPMENT_TYPES.VOLTAGE_LEVEL,
    EQUIPMENT_TYPES.BATTERY,
    EQUIPMENT_TYPES.BUS,
...
export const COUNTRY_TWO_SIDED_EQUIPMENTS = [
    EQUIPMENT_TYPES.LINE,
    EQUIPMENT_TYPES.TIE_LINE,
    EQUIPMENT_TYPES.DANGLING_LINE,
    EQUIPMENT_TYPES.HVDC_LINE,
...
export const THREE_SIDED_EQUIPMENTS = [EQUIPMENT_TYPES.THREE_WINDINGS_TRANSFORMER];
