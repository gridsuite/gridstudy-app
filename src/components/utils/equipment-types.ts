...
export const EQUIPMENTS_WITH_ONE_NOMINAL_VOLTAGE: readonly EQUIPMENT_TYPES[] = [
...
export const EQUIPMENTS_WITH_TWO_NOMINAL_VOLTAGES: readonly EQUIPMENT_TYPES[] = [
...
export const EQUIPMENTS_WITH_THREE_NOMINAL_VOLTAGES: readonly EQUIPMENT_TYPES[] = [
    EQUIPMENT_TYPES.THREE_WINDINGS_TRANSFORMER,
];

export const EQUIPMENTS_WITH_ONE_SUBSTATION: readonly EQUIPMENT_TYPES[] = [
    EQUIPMENT_TYPES.SUBSTATION,
    EQUIPMENT_TYPES.VOLTAGE_LEVEL,
    EQUIPMENT_TYPES.BATTERY,
    EQUIPMENT_TYPES.BUS,
...
export const EQUIPMENTS_WITH_TWO_SUBSTATIONS: readonly EQUIPMENT_TYPES[] = [
    EQUIPMENT_TYPES.LINE,
    EQUIPMENT_TYPES.HVDC_LINE,
];
