...
export const TwtTapChangerCharacteristics: React.FC<TwtTapChangerCharacteristicsProps> = ({ equipmentInfos }) => {
    ...
    if (ratioTapChanger) {
        rows.push({
            ...
            rho: ratioTapChanger.tapPosition ? ratioTapChanger.steps[ratioTapChanger.tapPosition].rho : '-',
            alpha: '-',
    ...
    if (phaseTapChanger) {
        rows.push({
            ...
            rho: '-',
            alpha: phaseTapChanger.tapPosition ? phaseTapChanger.steps[phaseTapChanger.tapPosition].alpha : '-',
