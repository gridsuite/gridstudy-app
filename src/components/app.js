...
const App = () => {
    ...
    function studyManager() {
        return (
            <StudyManager
                onClick={(studyUuid) => studyClickHandler(studyUuid)}
            />
        );
    }
    ...
    function studyPane() {
        return (
            <StudyPane view={STUDY_VIEWS[tabIndex]} onChangeTab={onChangeTab} />
        );
    }

    function errorLogout() {
        return <h1>Error: logout failed; you are still logged in.</h1>;
    }
