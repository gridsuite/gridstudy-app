            ...
            <>
                                ...
                                <Grid container className={classes.grid}>
                                    ...
                                    <Grid container item className={classes.grid}>
                                    {
                                        Object.keys(result.metrics).map((key) => ( 
                                            <>
                                                <Grid item xs={4} className={classes.subGrid}>
                                                    <Typography component="span" variant="body1">
                                                        <Box m={1}>
                                                            {key}:
                                                        </Box>
                                                ...
                                                <Divider />
                                                <Grid item xs={8} className={classes.subGrid}>
                                                    <Typography component="span" variant="body1">
                                                        <Box m={1}>
                                                            {result.metrics[key]}
                                                        </Box>
                ...
                <Paper className={classes.tablePaper}>
                    ...
                    <VirtualizedTable
                        ...
                        rowGetter={({ index }) => result.componentResults[index]}
                        columns={[
                        {
                            width: 200,
                            label: intl.formatMessage({ id: 'componentNum' }),
                        ...
                        {
                            width: 200,
                            label: intl.formatMessage({ id: 'iterationCount' }),
                            dataKey: 'iterationCount',
                        },
                        {
                            width: 200,
                            label: intl.formatMessage({ id: 'slackBusId' }),
                            dataKey: 'slackBusId',
                        },
                        {
                            width: 400,
                            label: intl.formatMessage({ id: 'slackBusActivePowerMismatch' }),
